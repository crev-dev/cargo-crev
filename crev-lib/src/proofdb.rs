...
impl ProofDB {
    ...
    /// Find URL belonging to an Id, which has been verified (either by fetching or by trust proof)
    ...
    /// Find URL belonging to an Id with a fallback to unverified information from any mention anywhere
